 ...
 <br><br> <br><br> <br><br>
	<div align="center">
		...
		<div style="margin-bottom: 10px;" class="target">
				<input type="radio" class="checkbox" id="search_1" name="search_total" onclick="search_check(1)" checked="checked">
				<label class="label"	for="search_1">아이디 찾기</label>
		</div>
		<div class="target">
				<input type="radio" class="checkbox" id="search_2" name="search_total" onclick="search_check(2)"> 
